...
namespace sp16_p3_g8WebAPI.Controllers.MVC
{
    public class ShowtimesController : Controller
    {
        ...
        {
            //var showtimes = db.Showtimes.Include(s => s.Screen);
        ...
        { 
         ...
         //   ViewBag.ScreenId = new SelectList(db.Screens, "Id", "Id");
        ...
        public ActionResult Create([Bind(Include = "Id,ScreenId,MovieId,StartDateTime")] Showtime showtime)
        {
           ...
           // ViewBag.ScreenId = new SelectList(db.Screens, "Id", "Id", showtime.ScreenId);
            return View(showtime);
        }
